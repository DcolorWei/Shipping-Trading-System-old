<template>
    <div>
        <el-container>
            <el-header>
                <el-menu id="indexMenu" default-active="apperance" mode="horizontal">
                    <el-menu-item index="home">首页</el-menu-item>
                    <el-menu-item index="apperance">仪表</el-menu-item>
                ...
                <el-aside width="150px">
                    <el-col>
                        <el-menu default-active="" class="el-menu-vertical-demo">
                            <el-menu-item index="a">区块查询</el-menu-item>
                            <el-menu-item index="b">信息管理</el-menu-item>
                            <el-menu-item index="c">安全设置</el-menu-item>
                            <el-menu-item index="d">退出登录</el-menu-item>
                        </el-menu>
                    </el-col>
                </el-aside>
                <el-container>
